...
client.on(appEvents.guildCreate, (guild) =>
	appHandlers.handleGuildCreate(client, guild)
);
client.on(appEvents.guildDelete, (guild) =>
	appHandlers.handleGuildDelete(client, guild)
);
...
client.on(appEvents.voiceStateUpdate, (oldState, newState) =>
	appHandlers.handleVoiceStateUpdate(player, oldState, newState)
);
